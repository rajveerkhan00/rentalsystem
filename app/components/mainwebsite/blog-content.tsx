        ...
        <section className="relative min-h-screen bg-black overflow-hidden pt-32 pb-24">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="max-w-4xl mx-auto text-center mb-20 relative">
                    ...
                    <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-lg shadow-pink-500/10 mb-6">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight">
                        Explore Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-rose-500 animate-gradient-x">Latest Insights</span>
                    </h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {posts.map((post) => (
                        <div
                            key={post.id}
                            className="group relative bg-[#0A0A0A]/80 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-pink-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-pink-500/10 flex flex-col"
                        >
                            <Link href={`/blog/${post.slug}`} className="cursor-pointer block flex-grow">
                                ...
                                <div className="relative h-64 w-full overflow-hidden">
                                    ...
                                    {/* Category Badge */}
                                    <div className="absolute top-6 left-6 px-4 py-1.5 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white text-[10px] font-bold uppercase tracking-widest shadow-lg">
                                        {post.category}
                                    </div>
                                </div>
                                ...
                                <div className="p-8 space-y-4">
                                    ...
                                    <h3 className="text-2xl font-bold text-white leading-tight group-hover:text-pink-400 transition-colors duration-300">
                                        {post.title}
                                    </h3>
                                    ...
                                    {/* Read More */}
                                    <div className="flex items-center gap-2 text-pink-500 text-sm font-bold pt-4 group-hover:gap-4 transition-all duration-300">
                            ...
                            {/* Decorative Glow */}
                            <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 to-purple-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
                        </div>
                    ))}
                </div>
            </div>
