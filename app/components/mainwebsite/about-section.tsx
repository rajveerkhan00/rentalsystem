  ...
  return (
    <section className="relative py-24 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_85%_70%,rgba(168,85,247,0.15),transparent_35%)]" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative group/image">
            ...
            <div className="absolute -bottom-8 -right-8 lg:right-[-40px] bg-[#0A0A0A]/90 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-[0_20px_50px_rgba(236,72,153,0.2)] ring-1 ring-white/5 max-w-[320px] animate-float z-20">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg shadow-pink-500/30">
              ...
              <p className="font-bold text-white text-sm flex items-center gap-2">
                <span className="w-6 h-px bg-pink-500/50"></span>
                Chase Foster
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pink-500/10 border border-pink-500/20">
                ...
                <p className="text-pink-500 font-bold tracking-[0.2em] uppercase text-[10px]">Over 10 Years Experience</p>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white text-balance tracking-tight leading-tight">
                TAXI TRANSFERS TO <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 bg-[length:200%_auto] animate-gradient-x">ALL LONDON AIRPORTS</span>
              </h2>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl flex items-start gap-6 group hover:bg-white/10 transition-all duration-500 hover:shadow-[0_0_30px_rgba(236,72,153,0.1)] hover:-translate-y-1">
                <div className="relative">
                  <div className="absolute -inset-2 bg-pink-500/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  <div className="relative bg-gradient-to-br from-pink-500 to-purple-600 w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-pink-500/40 group-hover:rotate-12 transition-transform duration-500">
                    <Map className="w-8 h-8 text-white" />
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2 text-white group-hover:text-pink-400 transition-colors tracking-tight">DOOR-TO-DOOR PREMIUM</h3>
              ...
              {/* Taxi Tour Services */}
              <div className="bg-gradient-to-r from-pink-500/10 to-purple-600/10 border border-pink-500/20 p-6 rounded-2xl flex items-start gap-4 group hover:border-pink-500/40 transition-colors duration-300">
                <div className="bg-white/10 w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 border border-white/10">
                  <Car className="w-7 h-7 text-pink-500" />
                </div>
                <div>
            ...
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl flex items-center gap-4 mt-12">
              <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-pink-500/30">
                <Image
              ...
              <div>
                ...
                <p className="text-lg font-bold text-white">
                  For Booking: <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-400 font-black tracking-wider">(+44) 7491 321 209</span>
                </p>
              </div>
            </div>
          </div>
